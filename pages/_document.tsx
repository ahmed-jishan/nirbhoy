...
export default function Document() {
  ...
  const csp = isDev
    ? [
        ...
        "connect-src 'self' https://api.cloudinary.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com ws:",
        "frame-src 'none'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
    ...
    : [
        ...
        "img-src 'self' data: blob: https://res.cloudinary.com",
        "media-src 'self' blob: https://res.cloudinary.com",
        "connect-src 'self' https://api.cloudinary.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com",
        "frame-src 'none'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
